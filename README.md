...
# 0250springboot基于springboot-vue的毕业论文管理系统
...
# 绪论
## 1.1 研究背景
当前社会各行业领域竞争压力非常大，随着当前时代的信息化，科学化发展，让社会各行业领域都争相使用新的信息技术，对行业内的各种相关数据进行科学化，规范化管理。这样的大环境让那些止步不前，不接受信息改革带来的信息技术的企业随时面临被淘汰，被取代的风险。所以当今，各个行业领域，不管是传统的教育行业，餐饮行业，还是旅游行业，医疗行业等领域都将使用新的信息技术进行信息革命，改变传统的纸质化，需要人手工处理工作事务的办公环境。软件信息技术能够覆盖社会各行业领域是时代的发展要求，各种数据以及文件真正实现电子化是信息社会发展的不可逆转的必然趋势。本毕业论文管理系统也是紧跟科学技术的发展，运用当今一流的软件技术实现软件系统的开发，让医生管理信息完全通过管理系统实现科学化，规范化，程序化管理。从而帮助信息管理者节省事务处理的时间，降低数据处理的错误率，对于基础数据的管理水平可以起到促进作用，也从一定程度上对随意的业务管理工作进行了避免，同时，毕业论文管理系统的数据库里面存储的各种动态信息，也为上层管理人员作出重大决策提供了大量的事实依据。总之，毕业论文管理系统是一款可以真正提升管理者的办公效率的软件系统。
## 1.2 目的和意义
信息数据的处理完全依赖人工进行操作，会耗费大量的人工成本，特别是面对大量的数据信息时，传统人工操作不仅不能对数据的出错率进行保证，还容易出现各种信息资源的低利用率与低安全性问题。更有甚者，耽误大量的宝贵时间，尤其是对信息的更新，归纳与统计更是耗财耗力的过程。所以电子化信息管理的出现就能缓解以及改变传统人工方式面临的处境，一方面可以确保信息数据在短时间被高效处理，还能节省人力成本，另一方面可以确保信息数据的安全性，可靠性，并可以实现信息数据的快速检索与修改操作，这些优点是之前的旧操作模式无法比拟的。因此毕业论文管理系统为数据信息的管理模式的升级与改革提供了重要的窗口。
## 1.3 论文结构安排
...
![C:\Users\Administrator\Desktop\img\biyeluenwenguanlix\课题信息.jpg](/md/blog.009.jpeg "C:\Users\Administrator\Desktop\img\biyeluenwenguanlix\课题信息.jpg")
图4.1 课题信息实体属性图

（2）下图是学生实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\biyeluenwenguanlix\学生.jpg](/md/blog.010.jpeg "C:\Users\Administrator\Desktop\img\biyeluenwenguanlix\学生.jpg")
图4.2 学生实体属性图

（3）下图是公告信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\biyeluenwenguanlix\公告信息.jpg](/md/blog.011.jpeg "C:\Users\Administrator\Desktop\img\biyeluenwenguanlix\公告信息.jpg")
图4.3 公告信息实体属性图

（4）下图是字典表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\biyeluenwenguanlix\字典表.jpg](/md/blog.012.jpeg "C:\Users\Administrator\Desktop\img\biyeluenwenguanlix\字典表.jpg")
图4.4 字典表实体属性图

（5）下图是选题申请实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\biyeluenwenguanlix\选题申请.jpg](/md/blog.013.jpeg "C:\Users\Administrator\Desktop\img\biyeluenwenguanlix\选题申请.jpg")
图4.5 选题申请实体属性图

（6）下图是评阅教师实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\biyeluenwenguanlix\评阅教师.jpg](/md/blog.014.jpeg "C:\Users\Administrator\Desktop\img\biyeluenwenguanlix\评阅教师.jpg")
图4.6 评阅教师实体属性图

（7）下图是毕业论文实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\biyeluenwenguanlix\毕业论文.jpg](/md/blog.015.jpeg "C:\Users\Administrator\Desktop\img\biyeluenwenguanlix\毕业论文.jpg")
图4.7 毕业论文实体属性图

（8）下图是课题任务实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\biyeluenwenguanlix\课题任务.jpg](/md/blog.016.jpeg "C:\Users\Administrator\Desktop\img\biyeluenwenguanlix\课题任务.jpg")
图4.8 课题任务实体属性图

（9）下图是用户表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\biyeluenwenguanlix\用户表.jpg](/md/blog.017.jpeg "C:\Users\Administrator\Desktop\img\biyeluenwenguanlix\用户表.jpg")
图4.9 用户表实体属性图

（10）下图是指导教师实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\biyeluenwenguanlix\指导教师.jpg](/md/blog.018.jpeg "C:\Users\Administrator\Desktop\img\biyeluenwenguanlix\指导教师.jpg")
图4.10 指导教师实体属性图
### 4.3.2 数据库表结构设计
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|keti\_name|String|课题名称|是|
|3|keti\_types|Integer|课题类型|是|
|4|keti\_text|String|课题内容|是|
|5|zhidaojiaoshi\_id|Integer|教师|是|
|6|keti\_yesno\_types|Integer|审核状态|是|
|7|keti\_yesno\_text|String|审核结果|是|
|8|create\_time|Date|创建时间|是|
表4.4课题任务表
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|zhidaojiaoshi\_id|Integer|教师|是|
|3|xuantishenqing\_id|Integer|选题申请|是|
|4|ketirenwu\_name|String|课题任务|是|
|5|ketirenwu\_types|Integer|任务类型|是|
|6|ketirenwu\_file|String|参考文献|是|
|7|ketirenwu\_huida\_file|String|阶段文档|是|
|8|ketirenwu\_yesno\_types|Integer|审核结果|是|
|9|ketirenwu\_yesno\_text|String|教师打分|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|xuantishenqing\_uuid\_number|String|课题编号|是|
|3|yonghu\_id|Integer|学生|是|
|4|keti\_id|Integer|课题|是|
|5|xuantishenqing\_yesno\_types|Integer|申请状态|是|
|6|xuantishenqing\_yesno\_text|String|申请结果|是|
|7|create\_time|Date|创建时间|是|
表4.8学生表
...
|4|yonghu\_address|String|家庭地址|是|
